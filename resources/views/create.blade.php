  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input class="form-control" type="text" id="code" maxlength="3" placeholder="Código del país">
        <input class="form-control" type="text" id="name" maxlength="100" placeholder="Nombre del país">
        <div class="alert alert-danger visually-hidden" role="alert" id="errorAlert">
          Error al insertar el país ...
        </div>
      </div>
